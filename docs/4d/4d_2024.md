...
| 2024 | **DreamScene4D: Dynamic Multi-Object Scene Generation from Monocular Videos**  | NeurIPS 2024 |          [Link](https://arxiv.org/abs/2405.02280)          | [Link](https://github.com/dreamscene4d/dreamscene4d)  |[Link](https://dreamscene4d.github.io/) |
...
| 2024 | **L4GM: Large 4D Gaussian Reconstruction Model**  | NeurIPS 2024 |          [Link](https://arxiv.org/abs/2406.10324)          | [Link](https://github.com/nv-tlabs/L4GM-official)  |[Link](https://research.nvidia.com/labs/toronto-ai/l4gm/) |
...
| 2024 | **Animate3D: Animating Any 3D Model with Multi-view Video Diffusion**  | NeurIPS 2024 |          [Link](https://arxiv.org/abs/2407.11398)          | [Link](https://github.com/yanqinJiang/Animate3D) | [Link](https://animate3d.github.io/) |
...
| 2024 | **Diffusion4D: Fast Spatial-temporal Consistent 4D Generation via Video Diffusion Models**  | NeurIPS 2024 |          [Link](https://arxiv.org/abs/2405.16645)          | [Link](https://github.com/VITA-Group/Diffusion4D)  |[Link](https://vita-group.github.io/Diffusion4D/) |
...
| 2024 | **4K4DGen: Panoramic 4D Generation at 4K Resolution**  | ICLR 2025 |          [Link](https://arxiv.org/abs/2406.13527)          | [Link](https://github.com/ShadowIterator/4K4DGen) | [Link](https://4k4dgen.github.io/index.html) |
...
| 2024 | **EG4D: Explicit Generation of 4D Object without Score Distillation**  | ICLR 2025 |         [Link](https://arxiv.org/abs/2405.18132)          | [Link](https://github.com/jasongzy/EG4D)  | -- |
|2024 | **4-LEGS: 4D Language Embedded Gaussian Splatting**  | Eurographics 2025 |          [Link](https://arxiv.org/abs/2410.10719)          |  [Link](https://github.com/TAU-VAILab/4-LEGS)   |  [Link](https://tau-vailab.github.io/4-LEGS/) |
| 2024 | **Disco4D: Disentangled 4D Human Generation and Animation from a Single Image**  | CVPR 2025 |          [Link](https://arxiv.org/abs/2409.17280)          | [Link](https://github.com/disco-4d/Disco4D) |  [Link](https://disco-4d.github.io/) |
...
| 2024 | **STAR: Skeleton-aware Text-based 4D Avatar Generation with In-Network Motion Retargeting**  | TVCG |          [Link](https://arxiv.org/abs/2406.04629)          | [Link](https://github.com/czh-98/STAR)      | [Link](https://star-avatar.github.io/) |
| 2024 | **Shape of Motion: 4D Reconstruction from a Single Video**  | ICCV 2025 (Highlight) |          [Link](https://arxiv.org/abs/2407.13764)          | [Link](https://github.com/vye16/shape-of-motion/) | [Link](https://shape-of-motion.github.io/) |
| 2024 | **DimensionX: Create Any 3D and 4D Scenes from a Single Image with Controllable Video Diffusion**  | ICCV 2025 |          [Link](https://arxiv.org/abs/2411.04928)          |  [Link](https://github.com/wenqsun/DimensionX)   |  [Link](https://chenshuo20.github.io/DimensionX/) |
| 2024 | **Fast Dynamic 3D Object Generation from a Single-view Video**  | IJCV 2026 |          [Link](https://arxiv.org/abs/2401.08742)          | [Link](https://github.com/fudan-zvg/Efficient4D)  | [Link](https://fudan-zvg.github.io/Efficient4D/)  |
...
#### 2. Comp4D: LLM-Guided Compositional 4D Scene Generation
...
#### 3. PLA4D: Pixel-Level Alignments for Text-to-4D Gaussian Splatting
...
#### 4. 4Dynamic: Text-to-4D Generation with Hybrid Priors
...
#### 5. CT4D: Consistent Text-to-4D Generation with Animatable Meshes
...
#### 6. Trans4D: Realistic Geometry-Aware Transition for Compositional Text-to-4D Synthesis
...
#### 7. PaintScene4D: Consistent 4D Scene Generation from Text Prompts
...
#### 8. ZeroHSI: Zero-Shot 4D Human-Scene Interaction by Video Generation
...
#### 9. Bringing Objects to Life: 4D generation from 3D objects
