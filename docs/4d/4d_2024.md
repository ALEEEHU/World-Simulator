...
#### 5. STAR: Skeleton-aware Text-based 4D Avatar Generation with In-Network Motion Retargeting
...
#### 6. Shape of Motion: 4D Reconstruction from a Single Video
...
#### 7. 4Dynamic: Text-to-4D Generation with Hybrid Priors
...
#### 8. CT4D: Consistent Text-to-4D Generation with Animatable Meshes
...
#### 9. Trans4D: Realistic Geometry-Aware Transition for Compositional Text-to-4D Synthesis
...
#### 10. DimensionX: Create Any 3D and 4D Scenes from a Single Image with Controllable Video Diffusion
...
#### 11. PaintScene4D: Consistent 4D Scene Generation from Text Prompts
...
#### 12. ZeroHSI: Zero-Shot 4D Human-Scene Interaction by Video Generation
...
#### 13. Bringing Objects to Life: 4D generation from 3D objects
