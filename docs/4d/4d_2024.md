...
#### 4. PLA4D: Pixel-Level Alignments for Text-to-4D Gaussian Splatting
...
#### 5. 4Dynamic: Text-to-4D Generation with Hybrid Priors
...
#### 6. CT4D: Consistent Text-to-4D Generation with Animatable Meshes
...
#### 7. Trans4D: Realistic Geometry-Aware Transition for Compositional Text-to-4D Synthesis
...
#### 8. PaintScene4D: Consistent 4D Scene Generation from Text Prompts
...
#### 9. ZeroHSI: Zero-Shot 4D Human-Scene Interaction by Video Generation
...
#### 10. Bringing Objects to Life: 4D generation from 3D objects
