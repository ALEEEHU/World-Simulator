...
#### 5. HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### 6. Scene123: One Prompt to 3D Scene Generation via Video-Assisted and Consistency-Enhanced MAE
