...
| 2025 | **WonderPlay: Dynamic 3D Scene Generation from a Single Image and Actions**  | ICCV 2025 |          [Link](https://arxiv.org/abs/2505.18151)          | [Link](https://github.com/kyleleey/WonderPlay) | [Link](https://kyleleey.github.io/WonderPlay/)  |
...
| 2025 | **Lumos-1: On Autoregressive Video Generation from a Unified Model Perspective**  | ICLR 2026 |      [Link](https://arxiv.org/abs/2507.08801)      | [Link](https://github.com/alibaba-damo-academy/Lumos) | -- |
| 2025 | **"PhyWorldBench": A Comprehensive Evaluation of Physical Realism in Text-to-Video Models**  | ICLR 2026 Oral |      [Link](https://www.arxiv.org/pdf/2507.13428)      | [Link](https://github.com/g-jing/phy-world-bench) | -- |
| 2025 | **LongLive: Real-time Interactive Long Video Generation**  | ICLR 2026 |      [Link](https://arxiv.org/abs/2509.22622)      | [Link](https://github.com/NVlabs/LongLive) | [Link](https://nvlabs.github.io/LongLive/) |
| 2025 | **SeqBench: Benchmarking Sequential Narrative Generation in Text-to-Video Models**  | CBMI 2025  |      [Link](https://arxiv.org/abs/2510.13042)      | [Link](https://github.com/TangZhengxu/SeqBench-Benchmarking-Sequential-Narrative-Generation-in-Text-to-Video-Models) | [Link](https://videobench.github.io/SeqBench.github.io/) |
| 2025 | **NovaFlow: Zero-Shot Manipulation via Actionable Flow from Generated Videos**  | ICRA 2026  |      [Link](https://arxiv.org/abs/2510.08568)      | [Link](https://github.com/rai-opensource/NovaFlow) | [Link](https://novaflow.lhy.xyz/) |
...
@inproceedings{tang2025seqbench,
...
#### 6. Can Your Model Separate Yolks with a Water Bottle? Benchmarking Physical Commonsense Understanding in Video Generation Models
...
#### 8. Yan: Foundational Interactive Video Generation
Yan Team (Tencent)
...
#### 9. Character Mixing for Video Generation
...
#### 10. Simulating the Visual World with Artificial Intelligence: A Roadmap
...
#### 11. Factorized Video Generation: Decoupling Scene Construction and Temporal Synthesis in Text-to-Video Diffusion Models
