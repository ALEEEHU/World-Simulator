...
#### 10. NovaFlow: Zero-Shot Manipulation via Actionable Flow from Generated Videos
...
#### 11. Simulating the Visual World with Artificial Intelligence: A Roadmap
...
#### 12. Factorized Video Generation: Decoupling Scene Construction and Temporal Synthesis in Text-to-Video Diffusion Models
